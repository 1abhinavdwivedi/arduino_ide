...
const char* serverAddress = "http://192.168.90.44:8000"; // Replace with your Django server address
...
void loop() {
  ...
  if (rfid.uid.uidByte[0] != nuidPICC[0] ||
    ...
    String postData = "cardID=" + hexString + "&scannerID=JBJDFH783GGR"; // Replace "uid" with your desired parameter name

    // Make the POST request
    http.begin(client, String(serverAddress) + "/api/demo"); // Replace "/your_django_endpoint/" with your Django endpoint
